...
export function SearchBarEnhanced({ className = "" }: SearchBarEnhancedProps) {
              ...
              <div>
                ...
                {results.length === 8 && (
                  <button
                    ...
                    className="w-full p-3 text-sm text-brand-teal-medium hover:bg-muted transition-colors font-medium"
                  >
